module github.com/anonymous-author-00000/ra-webs/monitor/client/example
...
require (
	...
	github.com/anonymous-author-00000/ra-webs/devkit/core v0.0.0-00010101000000-000000000000 // indirect
